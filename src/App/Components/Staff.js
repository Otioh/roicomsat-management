...
axios.post(Config.backend.endPoint.root+'staff.php', {first_name:firstName, surname, other_names:otherNames, religion, accno:accnumber, accname:accname, bank,  email,  phone, address, lga, state, gender, image, dob, marital, guarantor,guarantor_image, guarantor_phone, staff:'staff',designation}, {
  headers:{
